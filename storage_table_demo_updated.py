...
resourcegroup_name = 'eklt'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'eklt'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
print('Created entry for GM...')

car = Entity()
car.PartitionKey = 'carmenu'
car.RowKey = '002'
car.description = 'FORD'
car.cost = 15
table_service.insert_entity('itemstable', car)
